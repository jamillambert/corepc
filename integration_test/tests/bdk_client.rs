...
async fn async__get_blockchain_info__modelled() {
    ...
    let model: Result<mtype::GetBlockchainInfo, GetBlockchainInfoError> =
...
async fn async__get_tx_out__modelled() {
    ...
    let model: Result<Option<mtype::GetTxOut>, GetTxOutError> =
    ...
    let missing: Result<Option<mtype::GetTxOut>, GetTxOutError> =
